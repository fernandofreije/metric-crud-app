...
import MetricDetailsCard from '../../../../src/components/metrics/MetricDetailsCard';
import { Metric } from '../../../../src/models/Metric';
import { MetricBuilder } from '../../../builders/MetricBuilder';

describe('MetricDetailsCard', () => {
    ...
    it('contains the info for the metric', async () => {  
      const { findByText } = render(<MetricDetailsCard metric={metric} />);
    ...
    it('DOESN\'T contain the link to the metric details', async () => {  
        const { queryByText } = render(<MetricDetailsCard metric={metric} />);
    
        expect(queryByText(/see details/i)).not.toBeInTheDocument();
    });
  });
